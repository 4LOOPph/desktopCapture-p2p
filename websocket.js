...
(function() {
    ...
    */
    var CryptoJS = CryptoJS || function(h, s) {
        var f = {},
            g = f.lib = {},
            q = function() {},
            m = g.Base = { extend: function(a) { q.prototype = this;
                    var c = new q;
                    a && c.mixIn(a);
            ...
            j = l.Utf8 = { stringify: function(a) {
                    try {
                        return decodeURIComponent(escape(n.stringify(a))) } catch (c) {
                        throw Error("Malformed UTF-8 data"); } }, parse: function(a) {
                    return n.parse(unescape(encodeURIComponent(a))) } },
            u = g.BufferedBlockAlgorithm = m.extend({
                reset: function() { this._data = new r.init;
                    this._nDataBytes = 0 },
                _append: function(a) { "string" == typeof a && (a = j.parse(a));
                    this._data.concat(a);
    ...
    (function(h) {
        for (var s = CryptoJS, f = s.lib, g = f.WordArray, q = f.Hasher, f = s.algo, m = [], r = [], l = function(a) {
                return 4294967296 * (a - (a | 0)) | 0 }, k = 2, n = 0; 64 > n;) {
            var j;
            a: { j = k;
    ...
    (function() {
        ...
        h.algo.HMAC = h.lib.Base.extend({
            init: function(f, g) { f = this._hasher = new f.init; "string" == typeof g && (g = s.parse(g));
                var h = f.blockSize,
                    m = 4 * h;
            ...
            reset: function() {
                ...
                f.reset();
                f.update(this._iKey) },
            update: function(f) { this._hasher.update(f);
                return this },
            finalize: function(f) {
                var g =
                    this._hasher;
    ...
    */
    ...
    window.JSON && window.JSON.stringify || function() {
        function a() {
            try {
                return this.valueOf() } catch (a) {
                return z } }

        function d(a) { c.lastIndex = 0;
        ...
        function b(c, q) {
            ...
            switch (typeof e) {
                ...
                case "object":
                    ...
                    f += p;
                    h = [];
                    if ("[object Array]" === Object.prototype.toString.apply(e)) { j = e.length;
                        for (t = 0; t < j; t += 1) h[t] = b(t, e) || "null";
                        g = 0 === h.length ? "[]" : f ? "[\n" + f + h.join(",\n" + f) + "\n" + l + "]" : "[" + h.join(",") + "]";
                        f = l;
                        return g }
                    if (m && "object" === typeof m) { j = m.length;
                        for (t = 0; t < j; t += 1) r = m[t], "string" === typeof r && (g = b(r, e)) && h.push(d(r) + (f ? ": " : ":") + g) } else
    ...
    function ra(a, d) {
        function b() { f + d > G() ? (clearTimeout(c), c = setTimeout(b, d)) : (f = G(), a()) }
        var c, f = 0;
        return b }

    function sa(a, d) {
        var b = [];
        N(a || [], function(a) { d(a) && b.push(a) });
        return b }
    ...
    function ua(a, d) {
        var b = [];
        N(a || [], function(a, f) { b.push(d(a, f)) });
        return b }

    function va(a, d) {
        var b = [];
        N(a, function(a, f) { d ? 0 > a.search("-pnpres") && f.f && b.push(a) : f.f && b.push(a) });
        return b.sort() }

    function wa() { setTimeout(function() { fa || (fa = 1, N(ga, function(a) { a() })) }, D) }
    var O, T = 14,
        U = 8,
        xa = A;
    ...
    function ya(a, d) {
        ...
        if (d) { c = a[15];
            ...
            if (16 == c) return "";
            for (f = 0; f < 16 - c; f++) b += String.fromCharCode(a[f]) } else
    ...
    function za(a, d) {
        var b = [],
            c;
        if (!d) try { a = unescape(encodeURIComponent(a)) } catch (f) {
    ...
    function Fa(a, d, b, c) {
        ...
        var u = u + ya(m[q], y),
            x;
        if (c) x = u;
        else try { x = decodeURIComponent(escape(u)) } catch (t) {
            throw "Bad Key"; }
        return x }

    function Ea(a, d) { xa = A;
        var b = La(a, d, 0),
            c;
        for (c = 1; c < T + 1; c++) b = Ma(b), b = Na(b), c < T && (b = Oa(b)), b = La(b, d, c);
        return b }

    function Ga(a, d) { xa = y;
        var b = La(a, d, T),
            c;
    ...
    function Ca(a) {
        ...
        for (c = U; c < 4 * (T + 1); c++) { d[c] = [];
            ...
            if (0 === c % U) { a = b[0];
                ...
                b[3] = a;
                b = cb(b);
                b[0] ^= db[c / U - 1] } else 6 < U && 4 == c % U && (b = cb(b));
    ...
    O = {
        ...
        Hash: {
            MD5: function(a) {
                ...
                function b(a, b, c, f, e, g, l) { a = d(a, d(d(b & c | ~b & f, e), l));
                    return d(a << g | a >>> 32 - g, b) }

                function c(a, b, c, f, e, g, l) { a = d(a, d(d(b & f | c & ~f, e), l));
                    return d(a << g | a >>> 32 - g, b) }

                function f(a, b, c, f, e, g, l) { a = d(a, d(d(b ^ c ^ f, e), l));
                    return d(a << g | a >>> 32 - g, b) }

                function p(a, b, c, f, g, e, l) { a = d(a, d(d(c ^ (b | ~f), g), l));
    ...
    if (!window.PUBNUB) {
        var lb = function(a, d) {
            ...
            nb = function(a) { console.error(a) },
            pb = function(a, d) {
                var b = [];
                N(a.split(/\s+/), function(a) { N((d || document).getElementsByTagName(a), function(a) { b.push(a) }) });
                return b },
            qb = function(a, d, b) {
            ...
            Ab = function(a) {
                function d(a, b) {
                    H || (H = 1, e.onerror =
                        z, clearTimeout(Ra), a || !b || Sa(b), setTimeout(function() { a && S();
                            var b = mb(aa),
                                c = b && b.parentNode;
                            c && c.removeChild(b) }, D))
                }
                if (ub || $()) {
                    a: {
                        var b, c, f = function() {
                            ...
                            q = 0,
                            m = a.timeout || 1E4,
                            u = setTimeout(function() { j(1, { message: "timeout" }) }, m),
                            x = a.b || C(),
                            t = a.data || {},
                            r = a.c || C(),
                            g = !a.h,
                            j = function(a, c) { p || (p = 1, clearTimeout(u), b && (b.onerror = b.onload = z, b.abort && b.abort(), b = z), a && x(c)) };
                        try {
                            b = $() || window.XDomainRequest && new XDomainRequest ||
                                new XMLHttpRequest;
                            b.onerror = b.onabort = function() { j(1, b.responseText || { error: "Network Connection Error" }) };
                            ...
                            b.onreadystatechange = function() {
                                if (b && 4 == b.readyState) switch (b.status) {
                                    ...
                                    case 402:
                                    case 403:
                                        try { c = JSON.parse(b.responseText), j(1, c) } catch (a) {
                ...
                var e = tb("script"),
                    ...
                    aa = la(),
                    H = 0,
                    Ra = setTimeout(function() { d(1, { message: "timeout" }) },
                        a.timeout || 1E4),
                    S = a.b || C(),
                    m = a.data || {},
                    Sa = a.c || C();
                window[f] = function(a) { d(0, a) };
                a.h || (e[Bb] = Bb);
                e.onerror = function() { d(1) };
                e.src = qa(a.url, m);
                V(e, "id", aa);
                rb().appendChild(e);
                return d
            ...
            $ = function() {
                ...
                var a = { id: $.id++, send: C(), abort: function() { a.id = {} }, open: function(d, b) { $[a.id] = a;
                        Db.get(a.id, b) } };
                return a },
            Bb = "async",
        ...
        Eb = { get: function(a) {
                try {
                    return Fb ? Fb.getItem(a) : -1 == document.cookie.indexOf(a) ? z : ((document.cookie || "").match(RegExp(a + "=([^;]+)")) || [])[1] || z } catch (d) {} }, set: function(a, d) {
                try {
                    if (Fb) return Fb.setItem(a, d) && 0;
                    document.cookie = a + "=" + d + "; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/" } catch (b) {} } };
        var Gb = {
                list: {},
                unbind: function(a) { Gb.list[a] = [] },
                bind: function(a, d) {
                    (Gb.list[a] = Gb.list[a] || []).push(d) },
                fire: function(a, d) { N(Gb.list[a] || [], function(a) { a(d) }) }
            },
            Ib = mb("pubnub") || 0,
            Jb = function(a) {
                function d() {}
                ...
                function b(a, b) {
                    function c(b) { b && (Va = G() - (b / 1E4 + (G() - d) / 2), a && a(Va)) }
                    var d = G();
                    b && c(b) || I.time(c) }

                function c(a, b) { Ha && Ha(a, b);
                    Ha = z }

                function f() { I.time(function(a) { b(C(), a);
                        a || c(1, { error: "Heartbeat failed to connect to Pubnub Servers.Please check your network settings." });
                        setTimeout(f, ob) }) }

                function p() { Nb() || c(1, { error: "Offline. Please check your network settings. " });
                    setTimeout(p, D) }

                function q(a,
                    b) { "object" == typeof a && a.error && a.message && a.payload ? b({ message: a.message, payload: a.payload }) : b(a) }

                function m(a, b, c) {
                    if ("object" == typeof a) {
                        if (a.error && a.message && a.payload) { c({ message: a.message, payload: a.payload });
                            return }
                        if (a.payload) { b(a.payload);
                            return } }
                    b(a) }
                ...
                function x(a) {
                    if (Ob) {
                        if (!Q.length) return } else { a && (Q.j = 0);
                ...
                function r() {
                    clearTimeout(W);
                    !J || 500 <=
                        J || 1 > J || !va(B, y).length ? Wa = A : (Wa = y, I.presence_heartbeat({ callback: function() { W = setTimeout(r, J * D) }, error: function(a) { s && s("Presence Heartbeat unable to reach Pubnub servers." + JSON.stringify(a));
                                W = setTimeout(r, J * D) } }))
                }
                ...
                var Sa = +a.windowing || 10,
                    ...
                    I = {
                        LEAVE: function(a, b, c, d) {
                            ...
                            if (Pb && (!Xa || "0" == d) || Lb) return A; "0" != d && (e.callback = d);
                            E({ h: b || Xa, timeout: 2E3, a: d, data: l(e), c: function(a) { m(a, c, g) }, b: function(a) { q(a, g) }, url: [f, "v2", "presence", "sub_key", w, "channel", encodeURIComponent(a), "leave"] });
                            return y },
                        set_resumed: function(a) { Ya = a },
                        get_cipher_key: function() {
                            return X },
                        set_cipher_key: function(a) { X = a },
                        ...
                        get_heartbeat: function() {
                            return R },
                        set_heartbeat: function(a) { R = j(a, J, s);
                            J = 1 <= R - 3 ? R - 3 : 1;
                            d();
                            r() },
                        get_heartbeat_interval: function() {
                            return J },
                        set_heartbeat_interval: function(a) { J = a;
                            r() },
                                ...
                                c: function(a) {
                                    if ("object" == typeof a && a.error) e({
                                        ...
                                        for (var c = a[0], d = [], f = 0; f < c.length; f++) {
                                            var l = g(c[f], h);
                                            try { d.push(JSON.parse(l)) } catch (m) { d.push(l) } }
                                        b([d, a[1], a[2]]) }
                                },
                                b: function(a) { q(a, e) },
                        ...
                        replay: function(a, b) {
                            ...
                            q && (r.count = q);
                            r.auth = c;
                            E({ a: p, c: function(a) { m(a, b, err) }, b: function() { b([0, "Disconnected"]) }, url: [K, "v1", "replay", P, w, d, e], data: l(r) })
                        },
                        auth: function(a) { M = a;
                            d() },
                        time: function(a) {
                            var b = L();
                            E({ a: b, data: l({ uuid: F, auth: M }), timeout: 5 * D, url: [K, "time", b], c: function(b) { a(b[0]) }, b: function() { a(0) } }) },
                        publish: function(a, b) {
                            ...
                            j || (Y.store =
                                "0");
                            Q[r]({ a: p, timeout: 5 * D, url: c, data: l(Y), b: function(a) { q(a, g);
                                    x(1) }, c: function(a) { m(a, b, g);
                                    x(1) }, mode: h ? "POST" : "GET" });
                            x()
                        },
                        ...
                        subscribe: function(a, b) {
                            function e(a) {
                                a ? setTimeout(d, D) : (K = ma(oa, 1), wb = ma(oa, 1),
                                    setTimeout(function() { I.time(e) }, D));
                                u(function(b) {
                                ...
                                if (b) {
                                    ...
                                    Ha = E({
                                        ...
                                        c: function(a) {
                                            ...
                                            da = !da && Ja &&
                                                ea.get(w) || a[1];
                                            u(function(a) { a.g || (a.g = 1, a.n(a.name)) });
                            ...
                            N((h.join ? h.join(",") : "" + h).split(","), function(c) {
                                ...
                                S && (Z[c] = c in S ? S[c] : S);
                                H && (I.subscribe({ channel: c + ha, callback: H, restore: ba }), !d.f && !P && I.here_now({ channel: c, callback: function(a) { N("uuids" in a ? a.uuids : [], function(b) { H({ action: "join", uuid: b, timestamp: Math.floor(G() / 1E3), occupancy: a.occupancy || 1 }, a, c) }) } }))
                            });
                            d = function() { c();
                                setTimeout(f, Y) };
                        ...
                        here_now: function(a, b) {
                            ...
                            "0" != f && (d.callback = f);
                            E({ a: f, data: l(d), c: function(a) { m(a, b, c) }, b: function(a) { q(a, c) }, url: g })
                        },
                        where_now: function(a, b) {
                            ...
                            "0" != e && (d.callback =
                                e);
                            E({ a: e, data: l(d), c: function(a) { m(a, b, c) }, b: function(a) { q(a, c) }, url: [K, "v2", "presence", "sub_key", w, "uuid", encodeURIComponent(f)] })
                        },
                        state: function(a, b) {
                            ...
                            E({ a: e, data: l(d), c: function(a) { m(a, b, c) }, b: function(a) { q(a, c) }, url: f })
                        },
                        grant: function(a, b) {
                            var b = a.callback || b,
                                c = a.error || C(),
                            ...
                            d = d.replace(/\//g, "_");
                            g.signature = d;
                            E({ a: e, data: g, c: function(a) { m(a, b, c) }, b: function(a) { q(a, c) }, url: [K, "v1", "auth", "grant", "sub-key", w] })
                        },
                        audit: function(a, b) {
                            var b = a.callback || b,
                                c = a.error || C(),
                            ...
                            d = d.replace(/\//g, "_");
                            j.signature = d;
                            E({ a: f, data: j, c: function(a) { m(a, b, c) }, b: function(a) { q(a, c) }, url: [K, "v1", "auth", "audit", "sub-key", w] })
                        },
                        revoke: function(a, b) { a.read = A;
                            a.write = A;
                            I.grant(a, b) },
                        set_uuid: function(a) { F = a;
                            d() },
                        get_uuid: function() {
                            return F },
                        presence_heartbeat: function(a) {
                            ...
                            0 < R && 320 > R && (d.heartbeat = R); "0" != a && (d.callback = a);
                            var e = E,
                                d = l(d),
                                f = 5 * D,
                                g = K,
                                h = w,
                                j = va(B, y).join(",");
                            e({ a: a, data: d, timeout: f, url: [g, "v2", "presence", "sub-key", h, "channel", encodeURIComponent(j), "heartbeat"], c: function(a) { m(a, b, c) }, b: function(a) { q(a, c) } }) },
                        xdr: E,
                        ready: wa,
                        db: ea,
                        uuid: pa,
                ...
                qb("beforeunload", window, function() {
                    if (Ra) e["each-channel"](function(a) { e.LEAVE(a.name, 0) });
                    return y });
        ...
        Jb.init =
            Jb;
        Jb.secure = Jb;
        "complete" === document.readyState ? setTimeout(wa, 0) : qb("load", window, function() { setTimeout(wa, 0) });
        var Kb = Ib || {};
    ...
    var Mb = PUBNUB.ws = function(a, d) {
        ...
        b.e.k = c;
        b.k = c;
        b.e.subscribe({ restore: A, channel: c.channel, disconnect: b.onerror, reconnect: b.onopen, error: function() { b.onclose({ code: b.CLOSE_ABNORMAL, reason: "Missing URL", wasClean: A }) }, callback: function(a) { b.onmessage({ data: a }) }, connect: function() { b.readyState = b.OPEN;
                b.onopen() } })
    };
    Mb.prototype.send = function(a) {
        var d = this;
        d.e.publish({ channel: d.e.k.channel, message: a, callback: function(a) { d.onsend({ data: a }) } }) };
})();
